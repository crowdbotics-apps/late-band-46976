"""
Django settings for late_band_46976 project.
...
ROOT_URLCONF = 'late_band_46976.urls'
...
WSGI_APPLICATION = 'late_band_46976.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "late_band_46976 API",
    "DESCRIPTION": "API documentation for late_band_46976 App",
    "VERSION": "v1",
}
